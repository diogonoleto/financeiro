...
class UsuarioController  extends Controller
{
    ...
    public function store(Request $request, User $user)
    {
        ...
        return redirect()->route('usuario.edit', ['usuario' => $user->id]);
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        if ($request->acao == "endereco") {
            ...
            $delete = $usuario;
            if ($delete)
                return redirect()->route('usuario.edit', ['usuario' => $usuario->user_id]);
        }
    ...
    public function endereco(Request $request, UserEndereco $endereco)
    {
        ...
        return redirect()->route('usuario.edit', ['usuario' => $request->user_id]);
    }
    public function contato(Request $request, UserContato $contato)
    {
        ...
        return redirect()->route('usuario.edit', ['usuario' => $contato->user_id]);
    }
    public function conta(Request $request, UserConta $conta)
    {
        ...
        return redirect()->route('usuario.edit', ['usuario' => $conta->user_id]);
    }
    public function maisInfo(Request $request, UserMaisInfo $maisInfo)
    {
        ...
        return redirect()->route('usuario.edit', ['usuario' => $maisInfo->user_id]);
    }
    ...
    public function avatarUser(Request $request)
    {
        ...
        if ($upload_success) {
            ...
            if ($resp) {
                ...
                return redirect()->route($red, ['usuario' => $request->id]);
            }
        }
    }
}
