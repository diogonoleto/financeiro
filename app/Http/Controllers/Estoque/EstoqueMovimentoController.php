...
use App\Models\Estoque\EstoqueMovimento;
...
class EstoqueMovimentoController extends Controller
{
  public function index()
  {
    ...
    return view('estoque.movimento.index', compact('title'));
  }
  public function create(EstoqueMovimento $estoque)
  {


    $fornecedores = Empresa::where('empresa_tipo_id', 2)->get();
    $item = $estoque;
    return view('estoque.movimento.create', compact('item', 'fornecedores'));
  }
