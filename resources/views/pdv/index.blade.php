...
<section class="content-header">
	...
	<div class="input-group pull-right" id="btn-tools">
		<div class="input-group-btn">
			<a href="#" class="btn btn-default btn-pdv-create" route="{{ route('pdv.create') }}" data-toggle="tooltip" title="Adicionar pdv" data-placement="bottom"><i class="mdi mdi-plus mdi-20px" aria-hidden="true"></i></a>
...
<section class="content">
	<div class="col-sm-12 col-xs-12 no-padding" id="pdv-list">
