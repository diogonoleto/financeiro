...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#grid-table-body").css("height", h -45);
    $('.ano-3').trigger("click");

    // const psc = new PerfectScrollbar('#conta', {
  ...
  $(document).on('click', '.ano', function(e){
    ...
    $.ajax({
      url: "{{ route('fin.rel.dre.m.lista') }}"+"?date="+date+"-01-01&lancamento="+lancamento+"&conta="+conta,
      type: "GET",
      dataType: "json",
      success: function(data){
        ...
        const psfc = new PerfectScrollbar('.div-center', {
