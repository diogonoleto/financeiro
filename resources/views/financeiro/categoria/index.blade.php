...
<style type="text/css">
    ...
    .grid-table a.btn-delete-nao {
        line-height: 43px;
        height: 43px;
        width: 100px;
    }

    a.btn-categoria-create,
    a.btn-subcategoria-create,
    a.btn-categoria-delete {
    ...
    .menubar-item:hover a:hover+.tools-categoria a,
    .tools-categoria:hover a {
        display: inline-block;
    }

    .menubar-item:hover a:hover+.tools-categoria.not-active a,
    .tools-categoria.not-active:hover a {
    ...
    .btn-subcategoria-create,
    .btn-categoria-delete,
    .btn-categoria-create,
    .btn-subcategoria-edit,
    .btn-sort,
    .btn-dre-edit {
        display: none;
        margin-left: 5px;
...
*/
  ...
  padding-left: 31px!important;
    ...
    .treeview .submenu .menu-dropdown:before,
    .treeview .submenu .submenu-target:before {
        content: "";
        position: absolute;
        width: 8px;
        height: 24px;
    ...
    .nova-subcategoria .form-control:focus {
        box-shadow: none;
    }
        ...
        if (ul.length > 0) {
            $(this).parent().parent().children("ul").addClass("in")
                .prepend(`<li class="submenu-item nova-subcategoria">
                    ...
                    <div class="col-xs-auto pr-2 text-right">
