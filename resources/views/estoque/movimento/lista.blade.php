...
<div class="col-xs-12 no-padding grid-table">
  ...
  <span class="tools-user">
    @can('estoque_entrada')
    <a href="#" route="{{ route('estoque.movimento.index', $i->id) }}" class="btn-estoque-movimento-entrada"><i class="mdi mdi-package-up mdi-24px"></i></a>
    @endcan
    @can('estoque_saida')
    <a href="#" route="{{ route('estoque.movimento.index', $i->id) }}" class="btn-estoque-movimento-saida"><i class="mdi mdi-package-down mdi-24px"></i></a>
    @endcan

    @can('estoque_update')
    <a href="#" route="{{ route('estoque.edit', $i->id) }}" class="btn-estoque-movimento-edit"><i class="mdi mdi-pencil mdi-24px"></i></a>
    @endcan
    @can('estoque_delete')
